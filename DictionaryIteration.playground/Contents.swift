 ...
 */
bestSellingAlbums["Pixies"] = "Doolittle"
...
if let album = bestSellingAlbums["Nirvana"] {
 ...
 */
for (band, album) in bestSellingAlbums {
 ...
 */
// A tuple is returned when iterating over a dictionary.
 ...
 */
// You could create a dictionary where the key is the grade and the value is the exam average.
